    ...
    */
        ...
        const global =
            ...
            React.createElement(CollapsableBox, {
                ...
                name: 'Global',
                isOpen: opened.some(
                    (item) => item === `${workingActivity}-Global`,
                ),
        ...
        const missions =
            ...
            React.createElement(CollapsableBox, {
                ...
                name: 'Missions',
                isOpen: opened.some(
                    (item) => item === `${workingActivity}-Missions`,
                ),
            ...
            components.map((component, index) => {
                ...
                return [
                    React.createElement(CollapsableBox, {
                        ...
                        isOpen: opened.some(
                            (item) =>
                                item === `${workingActivity}-${component.id}`,
                        ),
                        onClick: () =>
                            toggleBox(`${workingActivity}-${component.id}`),
                        indentLevel: level,
    ...
    return React.createElement(
        ...
        React.createElement(
            ...
            workingActivity &&
                populateInspector(
                    story.nodes.find((node) => node.id === workingActivity)
                        .components,
                    0,
                ),
        ),
