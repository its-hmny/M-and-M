...
var _export = function (options, source) {
  ...
  for (key in source) {
    ...
    if (options.bind && USE_NATIVE)
      resultProperty = functionBindContext(sourceProperty, global$1);
...
var map_1 = function (it) {
  var own = it.map;
  return it === ArrayPrototype$1 || (it instanceof Array && own === ArrayPrototype$1.map)
    ? map
    : own;
};
...
var filter_1 = function (it) {
  ...
  return it === ArrayPrototype$2 ||
    (it instanceof Array && own === ArrayPrototype$2.filter)
    ? filter
    : own;
};
...
var reduce_1 = function (it) {
  ...
  return it === ArrayPrototype$3 ||
    (it instanceof Array && own === ArrayPrototype$3.reduce)
    ? reduce
    : own;
};
...
var isArrayIteratorMethod = function (it) {
  return (
    it !== undefined && (iterators.Array === it || ArrayPrototype$4[ITERATOR$3] === it)
  );
};
...
var arrayFrom = function from(
  ...
  if (mapping)
    mapfn = functionBindContext(mapfn, argumentsLength > 2 ? arguments[2] : undefined, 2); // if the target is not iterable or it's an array with the default iterator - use a simple case
    ...
    return scheduler(
      boundArgs
        ? function () {
            ...
            (typeof handler == 'function' ? handler : Function(handler)).apply(
              this,
              args
            );
          }
...
var splice_1 = function (it) {
  ...
  return it === ArrayPrototype$5 ||
    (it instanceof Array && own === ArrayPrototype$5.splice)
    ? splice
    : own;
};
...
var reverse_1 = function (it) {
  ...
  return it === ArrayPrototype$6 ||
    (it instanceof Array && own === ArrayPrototype$6.reverse)
    ? reverse
    : own;
};
...
var arrayForEach =
  !STRICT_METHOD$2 || !USES_TO_LENGTH$6
    ? function forEach(
        callbackfn
        /* , thisArg */
      ) {
...
var forEach_1 = function (it) {
  ...
  return it === ArrayPrototype$7 ||
    (it instanceof Array && own === ArrayPrototype$7.forEach) || // eslint-disable-next-line no-prototype-builtins
...
var isIterable = function (it) {
  ...
  return (
    ...
    '@@iterator' in O || // eslint-disable-next-line no-prototype-builtins
...
var slice_1 = function (it) {
  ...
  return it === ArrayPrototype$8 ||
    (it instanceof Array && own === ArrayPrototype$8.slice)
    ? slice$2
    : own;
};
...
var concat_1 = function (it) {
  ...
  return it === ArrayPrototype$9 ||
    (it instanceof Array && own === ArrayPrototype$9.concat)
    ? concat
    : own;
};
...
function _unsupportedIterableToArray$1(o, minLen) {
  ...
  var n = slice$6((_context21 = Object.prototype.toString.call(o))).call(
    _context21,
    8,
    -1
  );
...
function pureDeepObjectAssign(base) {
  ...
  for (
    var _len = arguments.length, updates = new Array(_len > 1 ? _len - 1 : 0), _key = 1;
    _key < _len;
    _key++
  ) {
  ...
  return deepObjectAssign.apply(
    void 0,
    concat$2((_context = [{}, base])).call(_context, updates)
  );
}
/**
...
function deepObjectAssignNonentry() {
  ...
  if (values.length < 2) {
    ...
    return deepObjectAssignNonentry.apply(
      void 0,
      concat$2((_context2 = [deepObjectAssign(values[0], values[1])])).call(
        _context2,
        toConsumableArray(slice$6(values).call(values, 2))
      )
    );
  }
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done; ) {
      ...
      if (!Object.prototype.propertyIsEnumerable.call(b, prop));
        ...
        a[prop] !== null &&
        b[prop] !== null &&
        _typeof_1(a[prop]) === 'object' &&
        _typeof_1(b[prop]) === 'object' &&
        !isArray$5(a[prop]) &&
        !isArray$5(b[prop])
      ) {
...
Activator.prototype.destroy = function () {
  ...
  var _iterator2 = _createForOfIteratorHelper(
      reverse$2(
        (_context4 = splice$2((_context5 = this._cleanupQueue)).call(_context5, 0))
      ).call(_context4)
    ),
    _step2;
...
var entries_1 = function (it) {
  ...
  return it === ArrayPrototype$a ||
    (it instanceof Array && own === ArrayPrototype$a.entries) || // eslint-disable-next-line no-prototype-builtins
...
var values_1 = function (it) {
  ...
  return it === ArrayPrototype$b ||
    (it instanceof Array && own === ArrayPrototype$b.values) || // eslint-disable-next-line no-prototype-builtins
...
var sort_1 = function (it) {
  var own = it.sort;
  return it === ArrayPrototype$c || (it instanceof Array && own === ArrayPrototype$c.sort)
    ? sort
    : own;
};
...
var keys_1 = function (it) {
  ...
  return it === ArrayPrototype$d ||
    (it instanceof Array && own === ArrayPrototype$d.keys) || // eslint-disable-next-line no-prototype-builtins
    DOMIterables$3.hasOwnProperty(classof(it))
    ? keys$5
    : own;
};
...
var some_1 = function (it) {
  var own = it.some;
  return it === ArrayPrototype$e || (it instanceof Array && own === ArrayPrototype$e.some)
    ? some
    : own;
};
...
var collection = function (CONSTRUCTOR_NAME, wrapper, common) {
  ...
  if (
    ...
    IS_WEAK ||
      defineProperty$9(Constructor.prototype, 'size', {
        configurable: true,
        get: function () {
...
var getPrototypeOf$3 = createCommonjsModule(function (module) {
  function _getPrototypeOf(o) {
    module.exports = _getPrototypeOf = setPrototypeOf$2
      ? getPrototypeOf$2
      : function _getPrototypeOf(o) {
    ...
    [
      ...
      },
      {
        ...
        value: function flush() {
          ...
          forEach$2(
            (_context = splice$2((_context2 = this._queue)).call(_context2, 0))
          ).call(_context, function (entry) {
  ...
  createClass(DataSetPart, [
      ...
      value: function _trigger(event, payload, senderId) {
        ...
        forEach$2(
          (_context = concat$2((_context2 = [])).call(
            _context2,
            toConsumableArray(this._subscribers[event]),
            toConsumableArray(this._subscribers['*'])
          ))
    ...
    },
    {
      ...
      value: function off(event, callback) {
        ...
        this._subscribers[event] = filter$2((_context3 = this._subscribers[event])).call(
          _context3,
          function (subscriber) {
...
function _unsupportedIterableToArray$2(o, minLen) {
  ...
  var n = slice$6((_context10 = Object.prototype.toString.call(o))).call(
    _context10,
    8,
    -1
  );
  ...
  createClass(DataStream, [
            ...
            while (1) {
              switch ((_context.prev = _context.next)) {
                ...
                case 3:
                  ...
                  (_step$value = slicedToArray(_step.value, 2)),
                    (id = _step$value[0]),
                    (item = _step$value[1]);
                  _context.next = 7;
                  return [id, item];
            ...
            while (1) {
              switch ((_context2.prev = _context2.next)) {
                ...
                case 3:
                  ...
                  (_step2$value = slicedToArray(_step2.value, 2)),
                    (id = _step2$value[0]),
                    (item = _step2$value[1]);
                  _context2.next = 7;
                  return [id, item];
            ...
            while (1) {
              switch ((_context4.prev = _context4.next)) {
                ...
                case 3:
                  ...
                  (_step4$value = slicedToArray(_step4.value, 2)),
                    (item = _step4$value[1]);
                  _context4.next = 7;
                  return item;
    ...
    },
    {
      ...
      value: function toIdArray() {
        ...
        return map$2((_context5 = toConsumableArray(this._pairs))).call(
          _context5,
          function (pair) {
            return pair[0];
          }
    ...
    },
    {
      ...
      value: function toItemArray() {
        ...
        return map$2((_context6 = toConsumableArray(this._pairs))).call(
          _context6,
          function (pair) {
            return pair[1];
          }
                  ...
                  while (1) {
                    switch ((_context7.prev = _context7.next)) {
                      ...
                      case 3:
                        ...
                        (_step7$value = slicedToArray(_step7.value, 2)),
                          (id = _step7$value[0]),
                          (item = _step7$value[1]);
                  ...
                  while (1) {
                    switch ((_context8.prev = _context8.next)) {
                      ...
                      case 3:
                        ...
                        (_step9$value = slicedToArray(_step9.value, 2)),
                          (id = _step9$value[0]),
                          (item = _step9$value[1]);
                        _context8.next = 7;
    ...
    },
    {
      ...
      value: function sort(callback) {
        ...
        return new DataStream(
          defineProperty$7({}, iterator$4, function () {
            var _context9;

            return getIterator$1(
              sort$2((_context9 = toConsumableArray(_this._pairs))).call(
                _context9,
                function (_ref, _ref2) {
...
function _objectSpread(target) {
  for (var i = 1; i < arguments.length; i++) {
    ...
    if (i % 2) {
      var _context10;
      forEach$2((_context10 = ownKeys$4(Object(source), true))).call(
        _context10,
        function (key) {
      ...
      var _context11;
      forEach$2((_context11 = ownKeys$4(Object(source)))).call(
        _context11,
        function (key) {
  ...
  createClass(DataSet, [
    ...
    },
    {
      ...
      value: function add(data, senderId) {
        ...
        if (isArray$5(data)) {
          ...
          if (
            some$2(idsToAdd).call(idsToAdd, function (id) {
    ...
    },
    {
      ...
      value: function updateOnly(data, senderId) {
        ...
        var updateEventData = map$2(
          (_context = map$2(data).call(data, function (update) {
    ...
    },
    {
      ...
      value: function _filterFields(item, fields) {
        ...
        return reduce$2(
          (_context3 = isArray$5(fields) // Use the supplied array
            ? fields // Use the keys of the supplied object
            : keys$3(fields))
        ).call(
          _context3,
          function (filteredItem, field) {
    ...
    },
    {
      ...
      value: function max(field) {
        ...
        var _iterator = _createForOfIteratorHelper$2(
            values$3((_context5 = this._data)).call(_context5)
          ),
          _step;
    ...
    },
    {
      ...
      value: function min(field) {
        ...
        var _iterator2 = _createForOfIteratorHelper$2(
            values$3((_context6 = this._data)).call(_context6)
          ),
          _step2;
    ...
    },
    {
      ...
      value: function _updateItem(update) {
        ...
        if (id == null) {
          throw new Error(
            'Cannot update item: item has no id (item: ' + stringify$2(update) + ')'
          );
        }
        ...
        if (ids) {
          ...
          return new DataStream(
            defineProperty$7(
              {},
              iterator$4,
              bind$2((_context8 = entries$2(this._data))).call(_context8, this._data)
            )
          );
        }
      },
...
export { DataSet as D, isDataViewLike as i };
