...
function Xa(a, b, c, d) {
  ...
  f ||
    (Ta(b, c, e, d) && (c = null),
    d || null === e
      ? Ra(b) && (null === c ? a.removeAttribute(b) : a.setAttribute(b, '' + c))
      : e.mustUseProperty
...
function Uc(a, b) {
  a.blockedOn === b &&
    ...
    zc ||
      ((zc = !0),
      scheduler.unstable_scheduleCallback(scheduler.unstable_NormalPriority, Tc)));
}
function Vc(a) {
  function b(b) {
    return Uc(b, a);
      ...
      f
        ? (me &&
            ...
            (se || f !== oe.compositionStart
              ...
              : ((Yd = d), (Zd = 'value' in Yd ? Yd.value : Yd.textContent), (se = !0))),
...
var Re = 0,
  ...
  Ye = {
    ...
    extractEvents: function (a, b, c, d, e) {
      ...
      if (g) {
        if (
          ((g = b), (b = (b = c.relatedTarget || c.toElement) ? tc(b) : null), null !== b)
        ) {
          var h = dc(b);
  ...
  function ca(e, g, h, k) {
    ...
    if (null === m) {
      for (; y < h.length; y++)
        (m = p(e, h[y], k)),
          null !== m &&
            ((g = f(m, g, y)), null === t ? (l = m) : (t.sibling = m), (t = m));
      return l;
    }
      ...
      switch (f.$$typeof) {
        case Za:
          a: {
            ...
            f.type === ab
              ? ((d = Wg(f.props.children, a.mode, h, f.key)), (d.return = a), (a = d))
...
function hh(a) {
  for (var b = a; null !== b; ) {
    if (13 === b.tag) {
      ...
      if (
        null !== c &&
        ((c = c.dehydrated), null === c || c.data === Bd || c.data === Cd)
      )
        return b;
...
function zi(a) {
  switch (a.tag) {
    ...
    case 13:
      return (
        H(M), (b = a.effectTag), b & 4096 ? ((a.effectTag = (b & -4097) | 64), a) : null
      );
    case 19:
      return H(M), null;
    case 4:
    ...
    case 1:
      ...
      if (c.effectTag & 4)
        if (null === b) a.componentDidMount();
          ...
          var d =
            c.elementType === c.type ? b.memoizedProps : ig(c.type, b.memoizedProps);
    ...
    (a = e ? a.stateNode : a.stateNode.instance),
      b
        ...
        : (8 === c.nodeType
          ...
          (null !== c && void 0 !== c) || null !== b.onclick || (b.onclick = sd));
          ...
          case jj:
            if (1073741823 !== lj && null !== nj) {
              ...
              0 >= d
                ? (d = 0)
                : ((e = g.busyDelayMs | 0),
                  (f = $f() - (10 * (1073741821 - f) - (g.timeoutMs | 0 || 5e3))),
                  (d = f <= e ? 0 : e + d - f));
              if (10 < d) {
                xi(a, c);
                a.timeoutHandle = Hd(Jj.bind(null, a), d);
  ...
  do {
    ...
    if (0 === (X.effectTag & 2048)) {
      ...
      null !== a &&
        ...
        null !== X.lastEffect &&
          (null !== a.lastEffect && (a.lastEffect.nextEffect = X.firstEffect),
          (a.lastEffect = X.lastEffect)),
        1 < X.effectTag &&
          (null !== a.lastEffect ? (a.lastEffect.nextEffect = X) : (a.firstEffect = X),
          (a.lastEffect = X)));
    } else {
      b = zi(X);
    ...
    if (B !== q && q && q.ownerDocument && wd(q.ownerDocument.documentElement, q)) {
      null !== h &&
        ...
        'selectionStart' in q
          ...
          : ((w = ((B = q.ownerDocument || document) && B.defaultView) || window),
            w.getSelection &&
              ((w = w.getSelection()),
...
function Oj(a, b, c) {
  ...
  T === a && U === c
    ? S === vi || (S === ui && 1073741823 === lj && $f() - Ti < pj)
      ...
      : (oj = !0)
    : Aj(a, c) &&
      ((b = a.lastPingedTime), (0 !== b && b < c) || ((a.lastPingedTime = c), Z(a)));
}
function Vi(a, b) {
  var c = a.stateNode;
  null !== c && c.delete(b);
