import {
  t as _arrayLikeToArray,
  v as _unsupportedIterableToArray,
  k as deepmerge,
...
var createGenerateId = function createGenerateId(options) {
  ...
  return function (rule, sheet) {
    ...
    return (
      prefix + rule.key + '-' + moduleId + (jssId ? '-' + jssId : '') + '-' + ruleCounter
    );
  };
};
...
var propertyDetectors = plugins$1
  .filter(function (p) {
