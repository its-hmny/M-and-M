  ...
  (function (_React$PureComponent) {
    ...
    function QRCodeCanvas() {
      ...
      _this = _possibleConstructorReturn(
        this,
        (_getPrototypeOf2 = _getPrototypeOf(QRCodeCanvas)).call.apply(
          _getPrototypeOf2,
          [this].concat(args)
        )
      );
    ...
    _createClass(QRCodeCanvas, [
      ...
      },
      {
        ...
        value: function componentWillReceiveProps(nextProps) {
          ...
          var currentSrc =
            (_this$props$imageSett = this.props.imageSettings) === null ||
            _this$props$imageSett === void 0
              ? void 0
              : _this$props$imageSett.src;
          var nextSrc =
            (_nextProps$imageSetti = nextProps.imageSettings) === null ||
            _nextProps$imageSetti === void 0
              ? void 0
              : _nextProps$imageSetti.src;
