...
function useAutocomplete(props) {
  var _props$autoComplete = props.autoComplete,
    ...
    componentName =
      _props$componentName === void 0 ? 'useAutocomplete' : _props$componentName,
    ...
    disableCloseOnSelect =
      _props$disableCloseOn === void 0 ? false : _props$disableCloseOn,
    ...
    filterOptions =
      _props$filterOptions === void 0 ? defaultFilterOptions : _props$filterOptions,
    _props$filterSelected = props.filterSelectedOptions,
    filterSelectedOptions =
      _props$filterSelected === void 0 ? false : _props$filterSelected,
  ...
  function validOptionIndex(index, direction) {
    ...
    while (true) {
      ...
      var option = listboxRef.current.querySelector(
        '[data-option-index="'.concat(nextFocus, '"]')
  ...
  var setHighlightedIndex = useEventCallback(function (_ref2) {
    ...
    var option = listboxRef.current.querySelector(
      '[data-option-index="'.concat(index, '"]')
    );
  ...
  var selectNewValue = function selectNewValue(event, option) {
    ...
    var origin =
      arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'options';
