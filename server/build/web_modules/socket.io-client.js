import {
  ...
  b as getDefaultExportFromNamespaceIfNotNamed,
...
var socket$1 = createCommonjsModule(function (module, exports) {
  ...
  Socket.prototype.emit = function (ev) {
    ...
    var args = toArray_1(arguments);
    var packet = {
      type: (this.flags.binary !== undefined ? this.flags.binary : hasBinary2(args))
  ...
  Socket.prototype.onopen = function () {
    ...
    if ('/' !== this.nsp) {
      if (this.query) {
        var query =
          typeof this.query === 'object' ? parseqs.encode(this.query) : this.query;
