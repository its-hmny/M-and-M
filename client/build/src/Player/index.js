...
const buildViewContent = (components, storyRuntime) =>
    components.map((component) => {
        ...
        const storyProps = story
            ? createStoryProps(component, storyRuntime)
...
const Player = () => {
    ...
    useEffect(() => {
        ...
        return () => {
            ...
            axios
                .delete(`stats/${storyId}/${ids.player}`)
    ...
    if (status === 'LOADING') {
        return React.createElement('p', null, 'Loading story...');
    }
    ...
    if (status === 'FAILURE') {
        return React.createElement(
            'p',
            null,
            'An error occured while loading story. Try refresh page.',
        );
    }
    ...
    return React.createElement(
        React.Fragment,
        null,
        React.createElement('div', null, viewContent),
