...
import {
  ...
  b as _inheritsLoose,
} from './common/objectWithoutPropertiesLoose-2d09fd44.js';
import './common/index-c103191b.js';
import {
  h as hoistNonReactStatics_cjs,
  r as reactIs,
} from './common/hoist-non-react-statics.cjs-452b108e.js';
...
*/
  ...
  return function wrapWithConnect(WrappedComponent) {
    ...
    function ConnectFunction(props) {
      ...
      var ContextToUse = react.useMemo(
        function () {
      ...
      var childPropsSelector = react.useMemo(
        function () {
      ...
      var overriddenContextValue = react.useMemo(
        function () {
      ...
      var renderedWrappedComponent = react.useMemo(
        function () {
          return /*#__PURE__*/ react.createElement(
            WrappedComponent,
      ...
      var renderedChild = react.useMemo(
        function () {
...
var patch = function patch(line, value, otherValue) {
  ...
  return (
    (_ref = {}), (_ref[line] = value), (_ref[line === 'x' ? 'y' : 'x'] = otherValue), _ref
  );
};
...
var increase = function increase(target, axis, withPlaceholder) {
  if (withPlaceholder && withPlaceholder.increasedBy) {
    ...
    return _extends(
      ...
      target,
      ((_extends2 = {}),
      (_extends2[axis.end] = target[axis.end] + withPlaceholder.increasedBy[axis.line]),
      _extends2)
    );
  }
...
var distanceFromStartToBorderBoxCenter = function distanceFromStartToBorderBoxCenter(
  axis,
  box
) {
...
var distanceFromEndToBorderBoxCenter = function distanceFromEndToBorderBoxCenter(
  axis,
  box
) {
...
var getCrossAxisBorderBoxCenter = function getCrossAxisBorderBoxCenter(
  axis,
  target,
  isMoving
) {
...
var getResultWithoutDroppableDisplacement = function getResultWithoutDroppableDisplacement(
  _ref
) {
  var impact = _ref.impact,
    draggable = _ref.draggable,
...
var getCurrentPageBorderBoxCenter = function getCurrentPageBorderBoxCenter(
  draggable,
  afterCritical
) {
  var original = draggable.page.borderBox.center;
...
var getRequiredGrowthForPlaceholder = function getRequiredGrowthForPlaceholder(
  droppable,
  placeholderSize,
  draggables
) {
...
var patchDroppableMap = function (droppables, updated) {
  ...
  return _extends(
    {},
    droppables,
    ((_extends2 = {}), (_extends2[updated.descriptor.id] = updated), _extends2)
  );
};
...
var reducer = function (state, action) {
  ...
  if (action.type === 'INITIAL_PUBLISH') {
    ...
    var isWindowScrollAllowed = toDroppableList(dimensions.droppables).every(function (
      item
    ) {
...
var isCombineEqual = function isCombineEqual(first, second) {
  ...
  return (
    first.draggableId === second.draggableId && first.droppableId === second.droppableId
  );
};
...
var createDimensionMarshal = function (registry, callbacks) {
  ...
  var updateDroppableIsCombineEnabled = function updateDroppableIsCombineEnabled(
    id,
    isCombineEnabled
  ) {
    if (!collection) {
...
var createJumpScroller = function (_ref) {
  ...
  var scrollDroppableAsMuchAsItCan = function scrollDroppableAsMuchAsItCan(
    droppable,
    change
  ) {
    if (!canScrollDroppable(droppable, change)) {
  ...
  var scrollWindowAsMuchAsItCan = function scrollWindowAsMuchAsItCan(
...
function useStyleMarshal(contextId, nonce) {
  ...
  var setDynamicStyle = useCallback(
    memoizeOne(function (proposed) {
...
function useFocusMarshal(contextId) {
  ...
  var tryRestoreFocusRecorded = useCallback(
...
function useMouseSensor(api) {
  ...
  var startCaptureBinding = useMemo(
    function () {
      return {
        eventName: 'mousedown',
  ...
  var preventForcePressBinding = useMemo(
    function () {
      return {
  ...
  var listenForCapture = useCallback(
  ...
  var bindCapturingEvents = useCallback(
  ...
  var startPendingDrag = useCallback(
...
function useSensorMarshal(_ref4) {
  ...
  var tryAbandonLock = useCallback(
  ...
  var findClosestDraggableId = useCallback(
    function (event) {
      return tryGetClosestDraggableIdFromEvent(contextId, event);
    },
    [contextId]
  );
  var findOptionsForDraggable = useCallback(
    function (id) {
  ...
  var tryReleaseLock = useCallback(
...
function App(props) {
  ...
  var dimensionMarshal = useMemo(
    function () {
      return createDimensionMarshal(registry, marshalCallbacks);
    },
    [registry, marshalCallbacks]
  );
  var autoScroller = useMemo(
    function () {
...
function useDroppablePublisher(args) {
  ...
  var memoizedUpdateScroll = useMemo(
    function () {
  ...
  var scheduleScrollUpdate = useMemo(
    function () {
      return rafSchd(updateScroll);
    },
    [updateScroll]
  );
  var onClosestScroll = useCallback(
    function () {
      var dragging = whileDraggingRef.current;
  ...
  var getDimensionAndWatchScroll = useCallback(
...
var AnimateInOut = (function (_React$PureComponent) {
  ...
  function AnimateInOut() {
    ...
    _this =
      _React$PureComponent.call.apply(_React$PureComponent, [this].concat(args)) || this;
    _this.state = {
  ...
  AnimateInOut.getDerivedStateFromProps = function getDerivedStateFromProps(
    props,
    state
  ) {
...
function getDraggableSelector() {
  ...
  var getMemoizedSnapshot = memoizeOne(function (
    mode,
    isClone,
    draggingOver,
    combineWith,
  ...
  var getMemoizedProps = memoizeOne(function (
    offset,
    mode,
    dimension,
    isClone,
...
var makeMapStateToProps$1 = function makeMapStateToProps() {
  ...
  var getMapProps = memoizeOne(function (
    id,
    isEnabled,
  ...
  var selector = function selector(state, ownProps) {
    ...
    if (state.phase === 'IDLE' && state.completed && !state.shouldFlush) {
      ...
      var wasCombining = Boolean(
        _completed.impact.at && _completed.impact.at.type === 'COMBINE'
      );
